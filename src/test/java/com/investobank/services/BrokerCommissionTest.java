...
public class BrokerCommissionTest {
    ...
    public void testFixedBrokerCommissionCalculation(){
        ...
        assertEquals(5.0, brokerCommission.calculateCommission(Long.MAX_VALUE));
    }
    ...
    public void testVariableBrokerCommissionCalculation(){
        ...
        assertEquals(3.0, brokerCommission10to40.calculateCommission(35));
        assertEquals(VariableBrokerComission.COMMISSION_NOT_APPLICABLE_FOR_THIS_RANGE,  brokerCommission10to40.calculateCommission(41));
    }
